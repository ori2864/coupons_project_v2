...
public class AdminControllerAdvice {
    ...
    public String generalErrMessage(GeneralException e){
        return "error: "+e.getMessage();
    }
    @ExceptionHandler(value = CompanyException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public String companyErrMessage(CompanyException e){
        return "error: "+e.getMessage();
    }
    @ExceptionHandler(value = CustomerException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public String customerErrMessage(CustomerException e){
        return "error: "+e.getMessage();
    }
    @ExceptionHandler(value = CouponException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public String couponErrMessage(CouponException e){
        return "error: "+e.getMessage();
    }
